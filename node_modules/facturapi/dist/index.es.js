...
`) === 0 ? u.substr(1, u.length) : u;
      ...
      function v(r, i) {
        return new Promise(function(s, u) {
          ...
          a.onload = function() {
            ...
            p.url = "responseURL" in a ? a.responseURL : p.headers.get("X-Request-URL");
          ...
          a.open(f.method, ne(f.url), !0), f.credentials === "include" ? a.withCredentials = !0 : f.credentials === "omit" && (a.withCredentials = !1), "responseType" in a && (E.blob ? a.responseType = "blob" : E.arrayBuffer && f.headers.get("Content-Type") && f.headers.get("Content-Type").indexOf("application/octet-stream") !== -1 && (a.responseType = "arraybuffer")), i && typeof i.headers == "object" && !(i.headers instanceof d) ? Object.getOwnPropertyNames(i.headers).forEach(function(p) {
            a.setRequestHeader(p, y(i.headers[p]));
          }) : f.headers.forEach(function(p, D) {
            a.setRequestHeader(D, p);
  ...
  var _ = n.fetch ? n : o;
  t = _.fetch, t.default = _.fetch, t.fetch = _.fetch, t.Headers = _.Headers, t.Request = _.Request, t.Response = _.Response, e.exports = t;
})(P, P.exports);
var de = P.exports;
  ...
  if (t) {
    if (t.includes("image/") || t.includes("application/pdf") || t.includes("application/xml") || t.includes("application/zip"))
      if (I) {
        ...
        if (!o)
          return e.body;
        const { Readable: _ } = require("stream");
        return new _({
          read() {
...
class Oe {
  ...
  uploadCertificate(t, n, o, _) {
    ...
    return I ? c.append("cer", n, {
      ...
      filename: "key.key",
      contentType: "application/octet-stream"
    }) : c.append("key", o, "key.key"), c.append("password", _), this.client.put("/organizations/" + t + "/certificate", {
      formData: c
    });
  }
  /**
